            ...
            <div className="row">
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                ...
                <div className="resume-items">
                  {resumeData && resumeData.experiences.map((experience, index) => (<ExperienceItem
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                ...
                <div className="resume-items">
                  {resumeData && resumeData.educations.map((education, index) => (<EducationItem
                    education={education}
                    index={index}
            ...
            <div className="row">
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.primary.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.secondary.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
            ...
            <div className="row">
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.databases.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.tools.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
            ...
            <div className="row">
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.multimedia.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
              ...
              <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
                <div className="skills-list">
                  ...
                  <ul>
                    {resumeData && resumeData.skills && resumeData.skills.testing.map((skill, index) => (<SkillItem
                      skill={skill}
                      index={index}
